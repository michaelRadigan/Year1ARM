...
\begin{description}
\item[Non - flashing]
We would like to render the screen such that the sprite does not flash
\item[Movement]
Implement movement through the use of a button
\item[Columns]
Addition of columns and their movement, with column type being randomly generated
\item[Object contact]
Simulation actual game play
\item[Sound]
Implementing sound would have been cool
\end{frame}
